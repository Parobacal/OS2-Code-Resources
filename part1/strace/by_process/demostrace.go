//==========================================
// Title:  DEMO STRACE BY PID
// Author: Orfrant Rivera
// Date:   2022
//==========================================
...
func viewHandler(w http.ResponseWriter, r *http.Request) {
    ...
    fmt.Fprintf(w, "<h1>Editing %s</h1>"+
        "<form action=\"/atach/%s\" method=\"POST\">"+
        "<textarea name=\"pid\"></textarea><br>"+
        "<input type=\"submit\" value=\"Save\">"+
        "</form>",pid)
}


func atachHandler(w http.ResponseWriter, r *http.Request) {
    atachar(npid)
}
*/
...
func main(){
	...
	//http.HandleFunc("/atach/", atachHandler)
